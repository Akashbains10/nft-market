  ...
  return (
    <div className="rounded-xl border border-border bg-card shadow-lg overflow-hidden">
      ...
      <div className="p-8 space-y-6">
        ...
        {(royaltyPercentage || royaltyRecipient) && (
          <div className="border-t border-border pt-6">
            <h3 className="text-sm font-semibold text-foreground mb-4">
              Royalty Settings
            </h3>
            <div className="space-y-3">
              {royaltyPercentage && (
                <div className="flex items-center justify-between p-4 rounded-lg bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/20 border border-purple-200 dark:border-purple-800">
                  <div className="flex items-center gap-3">
              ...
              {royaltyRecipient && (
                <div className="p-4 rounded-lg bg-gradient-to-r from-teal-50 to-teal-100 dark:from-teal-950/20 dark:to-teal-900/20 border border-teal-200 dark:border-teal-800">
