    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {step === 'confirm' && 'Review the transaction details before proceeding.'}
        ...
        <div className="space-y-4">
            ...
            <>
              <div className="bg-muted/40 rounded-lg p-5 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground font-medium">NFT Name</span>
                ...
                <div className="h-px bg-border/40" />
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground font-medium">Gas Fee (Est.)</span>
                  <span className="font-semibold text-foreground">0.05 ETH</span>
                </div>
                <div className="h-px bg-border/40" />
                <div className="flex justify-between items-center pt-2">
                  <span className="text-sm text-muted-foreground font-semibold">Total</span>
                  <span className="font-bold text-primary text-lg">
                    {(parseFloat(extractPrice(nft) as string) + 0.05).toFixed(2)} ETH
                  </span>
                </div>
              </div>
          ...
          {step === 'success' && (
            <div className="flex flex-col items-center justify-center py-12 space-y-4">
              ...
              <div className="text-center space-y-2">
                <p className="font-semibold text-foreground text-lg">Transaction Complete</p>
                <p className="text-sm text-muted-foreground">
          ...
          {step === 'error' && (
            <div className="flex flex-col items-center justify-center py-12 space-y-4">
              ...
              <div className="text-center space-y-2">
                <p className="font-semibold text-foreground text-lg">Transaction Failed</p>
                <p className="text-sm text-muted-foreground">
                  {error}
                </p>
              </div>
