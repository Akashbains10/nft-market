...
contract RealEstate is ERC721URIStorage, ERC2981, Ownable {
    ...
    // maximum royalty in bps to guard against unbounded royalties (e.g., 1000 = 10%)
    uint96 public constant MAX_ROYALTY_BPS = 2000; // configurable guard

    event MintedWithRoyalty(
    ...
    constructor() ERC721("RealEstate", "REAL") Ownable(msg.sender) {}
    ...
    // this function is optional owner only use this to set default royalty for tokens that don't have per-token royalty
